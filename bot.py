...
def get_profession_from_role(role_name):
    """Mapea un nombre de rol al nombre de la profesión base usado en la BD."""
    mapping = {
        "Sastre": "Sastrería", 
        "Peletero": "Peletería", 
        "Herrero": "Herrería", 
    ...
    # Asume que el rol termina en ' Maestro' o es el nombre base
    base_name = role_name.replace(" Maestro", "")
        
    return mapping.get(base_name, None)
